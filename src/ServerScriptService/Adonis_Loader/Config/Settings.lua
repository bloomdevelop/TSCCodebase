...
settings.DataStore = "AdonisDataStore"					 -- DataStore the script will use for saving data; Changing this will lose any saved data
settings.DataStoreKey = "THISISCHANGEDDONOTTOUCHAAAA6543"			 -- CHANGE THIS TO SOMETHING RANDOM! Key used to encrypt all datastore entries; Changing this will lose any saved data
...
settings.Permissions = {
	...
	--Sets all fun commands to creator only
	"add:900";
	"glitch:900";
	"ghostglitch:900";
	"vibrate:900";
