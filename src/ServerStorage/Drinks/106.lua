local drink = {
	--Main
	Name = 'black corrosive liquid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 585364476; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Dispense1'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = "You feel strange. It's as if there was something moving in your stomach."; --Text shown on the screen after drinking the liquid
	...
	Bleedout = 4; --How many seconds the blood loss effect lasts for after drinking the liquid (setting this to nil will disable the effect)
	...
	Blur = 8; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
