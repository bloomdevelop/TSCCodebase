local drink = {
	--Main
	Name = 'SCP-1176-1'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'MummyLiquid', --The name of the script (setting this to nil will disable the effect)
