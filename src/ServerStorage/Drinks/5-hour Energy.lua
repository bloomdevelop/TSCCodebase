local drink = {
	--Main
	Name = '5-hour Energy'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = '5HourEnergy', --The name of the script (setting this to nil will disable the effect)
