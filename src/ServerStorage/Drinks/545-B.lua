local drink = {
	--Main
	Name = 'SCP-545-B'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel better.'; --Text shown on the screen after drinking the liquid
	...
	CustomEffect = {
		Script = 'LiquidLife', --The name of the script (setting this to nil will disable the effect)
