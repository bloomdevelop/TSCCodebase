local drink = {
	--Main
	Name = 'acai strawberry smoothie'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
...
local termToReplace = "name of the script"
local replaceWith = "name of the script"
