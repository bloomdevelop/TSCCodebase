local drink = {
	--Main
	Name = 'acetic acid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The liquid burns your mouth and throat.'; --Text shown on the screen after drinking the liquid
