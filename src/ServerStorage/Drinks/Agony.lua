local drink = {
	--Main
	Name = 'agony'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink tastes incredibly bitter. You feel a burning pain in your stomach.'; --Text shown on the screen after drinking the liquid
