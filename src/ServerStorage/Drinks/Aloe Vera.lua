local drink = {
	--Main
	Name = 'aloe vera juice'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	--Effect Settings
	Heal = 15; --The amount of health restored after drinking the liquid (setting this to math.huge will enable godmode)
