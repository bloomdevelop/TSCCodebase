local drink = {
	--Main
	Name = 'amnesia'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Daniel, is that you? What are you doing?'; --Text shown on the screen after drinking the liquid
