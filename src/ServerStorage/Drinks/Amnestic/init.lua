local drink = {
	--Main
	Name = 'Class-B'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel a migraine.'; --Text shown on the screen after drinking the liquid
