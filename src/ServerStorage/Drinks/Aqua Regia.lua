local drink = {
	--Main
	Name = 'aqua regia'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	RefuseMessage = 'Hmm... There should be more cuprite.'; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
