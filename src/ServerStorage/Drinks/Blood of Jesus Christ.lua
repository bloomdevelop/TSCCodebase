local drink = {
	--Main
	Name = "Jesus Christ's blood"; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	DispenseMessage = 'Hic est enim Calix Sánguinis mei'; --Changes the text shown on SCP-294's pad while dispensing (default is "Dispensing...")
