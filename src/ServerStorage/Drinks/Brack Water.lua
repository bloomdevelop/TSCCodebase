local drink = {
	--Main
	Name = 'brackish water'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink is very salty.'; --Text shown on the screen after drinking the liquid
