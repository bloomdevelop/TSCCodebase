local drink = {
	--Main
	Name = 'carrot juice'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Pretty good.'; --Text shown on the screen after drinking the liquid
