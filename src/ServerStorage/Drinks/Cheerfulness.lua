local drink = {
	--Main
	Name = 'cheerfulness'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'A overwhelming sense of happiness takes you over. Your heart is pounding like crazy.'; --Text shown on the screen after drinking the liquid
