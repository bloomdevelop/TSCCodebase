local drink = {
	--Main
	Name = 'chim'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'There are no words in any human language to describe the taste of the liquid.'; --Text shown on the screen after drinking the liquid
	...
	--Effect Settings
	Heal = 25; --The amount of health restored after drinking the liquid (setting this to math.huge will enable godmode)
	...
	Blur = 100; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
