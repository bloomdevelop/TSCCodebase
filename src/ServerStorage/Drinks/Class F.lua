local drink = {
	--Main
	Name = 'Class-F'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'ClassFAmnestics', --The name of the script (setting this to nil will disable the effect)
