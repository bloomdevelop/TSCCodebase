local drink = {
	--Main
	Name = 'Class-E'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'ClassEAmnestics', --The name of the script (setting this to nil will disable the effect)
