local drink = {
	--Main
	Name = 'clover honey'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Mmm... Sweet.'; --Text shown on the screen after drinking the liquid
