local drink = {
	--Main
	Name = 'coconut milk'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You enjoy the refreshing flavor of coconut milk.'; --Text shown on the screen after drinking the liquid
