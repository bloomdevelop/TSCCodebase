local drink = {
	--Main
	Name = 'cold brew tea'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'It tastes like cold tea.'; --Text shown on the screen after drinking the liquid
