local drink = {
	--Main
	Name = 'cold liquid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Your head aches from the freezing cold liquid.'; --Text shown on the screen after drinking the liquid
