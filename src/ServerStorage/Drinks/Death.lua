local drink = {
	--Main
	Name = 'death'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Lethal = 4; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
