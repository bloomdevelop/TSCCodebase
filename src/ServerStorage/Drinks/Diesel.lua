local drink = {
	--Main
	Name = 'diesel fuel'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel a burning pain in your abdomen and nauseated.'; --Text shown on the screen after drinking the liquid
