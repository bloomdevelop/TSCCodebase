local drink = {
	--Main
	Name = 'egg whites'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'It tastes just like raw eggs!'; --Text shown on the screen after drinking the liquid
