local drink = {
	--Main
	Name = 'estus'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The taste is hard to describe. You feel refreshed.'; --Text shown on the screen after drinking the liquid
