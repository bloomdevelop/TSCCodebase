local drink = {
	--Main
	Name = 'eye drops'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "The liquid tastes awful. Maybe it wasn't meant to be used orally."; --Text shown on the screen after drinking the liquid
