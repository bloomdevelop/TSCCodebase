local drink = {
	--Main
	Name = 'Fanta Fruit Twist'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'That tastes good...'; --Text shown on the screen after drinking the liquid
