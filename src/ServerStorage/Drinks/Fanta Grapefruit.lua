local drink = {
	--Main
	Name = 'Fanta Grapefruit'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Refreshing...'; --Text shown on the screen after drinking the liquid
