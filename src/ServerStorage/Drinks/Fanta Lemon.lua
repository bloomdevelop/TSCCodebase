local drink = {
	--Main
	Name = 'Fanta Lemon'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Take that! In one gulp, without breathing.'; --Text shown on the screen after drinking the liquid
