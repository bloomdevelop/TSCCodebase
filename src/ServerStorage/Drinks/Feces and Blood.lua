local drink = {
	--Main
	Name = 'feces and blood'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	RefuseMessage = "The drink smells like SCP-173's containment chamber."; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
	DispenseMessage = nil; --Changes the text shown on SCP-294's pad while dispensing (default is "Dispensing...")

	--Appearance
	Color = BrickColor.new('Flame reddish orange');
