local drink = {
	--Main
	Name = 'golden syrup'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'While irresistibly sweet, you become overpowered by the sweetness to the point of nausea.'; --Text shown on the screen after drinking the liquid
	...
	Blur = 7; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
