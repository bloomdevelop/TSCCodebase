local drink = {
	--Main
	Name = 'hatred'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Your blood boils with overwhelming hatred towards everything.'; --Text shown on the screen after drinking the liquid
