local drink = {
	--Main
	Name = 'ink'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You recoil from the powerful odor of the liquid.'; --Text shown on the screen after drinking the liquid
