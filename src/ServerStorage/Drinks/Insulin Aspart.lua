local drink = {
	--Main
	Name = 'insulin aspart'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'It smells strong... but it tastes slightly of milk...'; --Text shown on the screen after drinking the liquid
