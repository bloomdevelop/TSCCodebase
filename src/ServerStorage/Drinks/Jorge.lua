local drink = {
	--Main
	Name = 'Jorge'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel as though someone is expecting you.'; --Text shown on the screen after drinking the liquid
	...
	--Effect Settings
	Heal = 20; --The amount of health restored after drinking the liquid (setting this to math.huge will enable godmode)
