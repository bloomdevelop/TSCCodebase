local drink = {
	--Main
	Name = 'eau de cologne'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	RefuseMessage = "While it does smell lovely, I'd rather wear it than drink it."; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
