local drink = {
	--Main
	Name = 'Latex'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'LatexInfect', --The name of the script (setting this to nil will disable the effect)
