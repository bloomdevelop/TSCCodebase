local drink = {
	--Main
	Name = 'Lava Cola'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink tastes like cough syrup.'; --Text shown on the screen after drinking the liquid
