local drink = {
	--Main
	Name = 'life'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "The drink tastes unlike anything you've drank before. You feel better than ever."; --Text shown on the screen after drinking the liquid
	...
	--Effect Settings
	Heal = 100; --The amount of health restored after drinking the liquid (setting this to math.huge will enable godmode)
