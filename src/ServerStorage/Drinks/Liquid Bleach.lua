local drink = {
	--Main
	Name = 'sodium hypochlorite'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Lethal = 50; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
