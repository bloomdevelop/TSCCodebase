local drink = {
	--Main
	Name = 'liquid bromine'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 2752122246; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Dispense1'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = 'The liquid burns your throat.'; --Text shown on the screen after drinking the liquid
	...
	--Appearance
	Color = BrickColor.new('Dirt brown');
	...
	Bleedout = 6; --How many seconds the blood loss effect lasts for after drinking the liquid (setting this to nil will disable the effect)
	...
	Blur = 60; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
