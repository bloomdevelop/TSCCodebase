local drink = {
	--Main
	Name = 'liquid nylon'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The liquid burns your mouth instantly.'; --Text shown on the screen after drinking the liquid
