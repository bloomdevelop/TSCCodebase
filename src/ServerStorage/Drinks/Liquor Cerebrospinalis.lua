local drink = {
	--Main
	Name = 'cerebrospinal fluid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "It is mildly salty, tepid and watery. I shouldn't really be drinking this."; --Text shown on the screen after drinking the liquid
