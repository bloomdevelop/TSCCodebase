local drink = {
	--Main
	Name = 'masala sauce'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Full of exotic spices and flavors, wet consistency, delicious.'; --Text shown on the screen after drinking the liquid
