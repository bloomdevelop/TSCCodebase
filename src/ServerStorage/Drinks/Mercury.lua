local drink = {
	--Main
	Name = 'liquid mercury'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink is thick like cream, and burns your throat.'; --Text shown on the screen after drinking the liquid
	...
	Blur = 50; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
