local drink = {
	--Main
	Name = 'molasses'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 2752122458; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Dispense1'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = 'The flavor is tangy and sweet, but a little too much for your liking.'; --Text shown on the screen after drinking the liquid
	...
	Blur = 1; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
