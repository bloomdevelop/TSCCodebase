local drink = {
	--Main
	Name = 'molten plastic'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The molten plastic burns your mouth.'; --Text shown on the screen after drinking the liquid
	...
	Bleedout = 8; --How many seconds the blood loss effect lasts for after drinking the liquid (setting this to nil will disable the effect)
