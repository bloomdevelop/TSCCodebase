local drink = {
	--Main
	Name = 'More Health'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel stronger.'; --Text shown on the screen after drinking the liquid
	...
	CustomEffect = {
		Script = 'MoreHealth', --The name of the script (setting this to nil will disable the effect)
