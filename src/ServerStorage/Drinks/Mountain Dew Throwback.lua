local drink = {
	--Main
	Name = 'Mountain Dew Throwback'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "It's nice and cold."; --Text shown on the screen after drinking the liquid
