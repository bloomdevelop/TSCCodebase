local drink = {
	--Main
	Name = 'music'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'It tastes remarkably bitter. You notice music playing uncontrollably within your head.'; --Text shown on the screen after drinking the liquid
	...
	Blur = 20; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
	Explosion = false; --Causes a explosion after the liquid is dispensed (true or false)
	CustomEffect = {
		Script = 'LocalMusic', --The name of the script (setting this to nil will disable the effect)
