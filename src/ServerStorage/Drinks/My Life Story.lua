local drink = {
	--Main
	Name = 'my life story'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'I remembered everything. I want to write a biography of my life.'; --Text shown on the screen after drinking the liquid
