local drink = {
	--Main
	Name = 'blood'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 2752228155; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Damage2'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = "The liquid tastes like blood. It's still warm."; --Text shown on the screen after drinking the liquid
	...
	Bleedout = 20; --How many seconds the blood loss effect lasts for after drinking the liquid (setting this to nil will disable the effect)
	...
	Blur = 10; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
