local drink = {
	--Main
	Name = 'nausea'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 2752123088; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Dispense3'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = "Ugg... I don't feel so good..."; --Text shown on the screen after drinking the liquid
	...
	Blur = 30; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
