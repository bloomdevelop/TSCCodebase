local drink = {
	--Main
	Name = 'orange juice'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink tastes sweet and has quite a bit of pulp.'; --Text shown on the screen after drinking the liquid
