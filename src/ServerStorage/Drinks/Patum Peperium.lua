local drink = {
	--Main
	Name = "Gentleman's Relish"; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink has a very salty and slightly fishy taste to it.'; --Text shown on the screen after drinking the liquid
	...
	--Appearance
	Color = BrickColor.new('Dark taupe');
