local drink = {
	--Main
	Name = 'Pepsi-Cola Made w/ Real Sugar'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "It's cold and refreshing."; --Text shown on the screen after drinking the liquid
