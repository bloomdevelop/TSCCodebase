local drink = {
	--Main
	Name = 'the perfect drink'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "I can't take this anymore, everything at this point is just one big letdown."; --Text shown on the screen after drinking the liquid
	...
	Lethal = 10; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
