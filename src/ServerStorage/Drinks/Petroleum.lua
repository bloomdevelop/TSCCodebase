local drink = {
	--Main
	Name = 'petroleum'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Bleedout = 3; --How many seconds the blood loss effect lasts for after drinking the liquid (setting this to nil will disable the effect)
