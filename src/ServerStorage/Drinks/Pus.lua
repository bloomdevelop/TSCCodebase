local drink = {
	--Main
	Name = 'pus'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "It smells like rancid egg salad. I think I'm going to puke!"; --Text shown on the screen after drinking the liquid
	...
	--Appearance
	Color = BrickColor.new('Tr. Yellow');
