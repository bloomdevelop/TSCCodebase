local drink = {
	--Main
	Name = 'apple juice w/ seeds'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink tastes like apple juice.'; --Text shown on the screen after drinking the liquid
	...
	--Appearance
	Color = BrickColor.new('Daisy orange');
