local drink = {
	--Main
	Name = 'SCP-195'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'MedicinalLiquid', --The name of the script (setting this to nil will disable the effect)
