local drink = {
	--Main
	Name = 'SCP-3238'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'DadoJuice', --The name of the custom effect (setting this to nil will disable the effect)
		EnableOnDrink = true, --(true makes the effect enable after drinking the liquid) (false makes the effect immediately enabled)
	}
}
