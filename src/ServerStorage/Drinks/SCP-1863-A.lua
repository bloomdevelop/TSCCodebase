local drink = {
	--Main
	Name = 'SCP-1863-A'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	CustomEffect = {
		Script = 'LimeLiftoff', --The name of the script (setting this to nil will disable the effect)
