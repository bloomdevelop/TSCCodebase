local drink = {
	--Main
	Name = 'SCP-505-1'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Lethal = 15; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
