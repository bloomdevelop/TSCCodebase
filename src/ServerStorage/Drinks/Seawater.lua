local drink = {
	--Main
	Name = 'saline water'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The extremely salty taste is almost unbearable. You begin to feel dehydrated and dizzy.'; --Text shown on the screen after drinking the liquid
	...
	--Effect Settings
	Heal = 0; --The amount of health restored after drinking the liquid
	...
	Blur = 4; --How many seconds the screen will be blurry for after drinking the liquid (settings this to nil will disable the effect)
