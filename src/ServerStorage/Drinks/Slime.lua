local drink = {
	--Main
	Name = 'slime'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	RefuseMessage = 'Why the hell would I want to drink this?'; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
