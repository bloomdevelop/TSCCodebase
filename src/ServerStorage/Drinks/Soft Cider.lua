local drink = {
	--Main
	Name = 'apple cider'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'A bit too sugary for me.'; --Text shown on the screen after drinking the liquid
