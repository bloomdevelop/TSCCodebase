local drink = {
	--Main
	Name = 'Empty Cup'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 0; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Dispense2'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	Message = ''; --Text shown on the screen after drinking the liquid
	RefuseMessage = "On the side of the empty cup, there's a image of a soda fountain glass filled with something brown and topped with whipped cream."; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
