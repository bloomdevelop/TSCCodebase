local drink = {
	--Main
	Name = 'carbonated water'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'Well, that was refreshing.'; --Text shown on the screen after drinking the liquid
