local drink = {
	--Main
	Name = 'spraint'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	RefuseMessage = "Yeah, I'm not drinking that."; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
