local drink = {
	--Main
	Name = 'strawberry juice'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'So sweet.'; --Text shown on the screen after drinking the liquid
