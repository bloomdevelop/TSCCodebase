local drink = {
	--Main
	Name = 'sulfuric acid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Lethal = 5; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
	Blur = 5; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
