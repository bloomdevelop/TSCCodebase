local drink = {
	--Main
	Name = 'water'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The water burns your mouth instantly.'; --Text shown on the screen after drinking the liquid
	...
	Blur = 2; --How many seconds the screen will be blurry for after drinking the liquid (setting this to nil will disable the effect)
	Explosion = false; --Causes a explosion after the liquid is dispensed (true or false)
	CustomEffect = {
		Script = 'SurpriseMe', --The name of the script (setting this to nil will disable the effect)
		EnableOnDrink = false, --(true makes the effect enabled after drinking the liquid) (false makes the effect enabled immediately)
	}
}
