local drink = {
	--Main
	Name = 'sweet lettuce smoothie'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The drink tastes sweet.'; --Text shown on the screen after drinking the liquid
