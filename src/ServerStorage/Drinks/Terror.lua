local drink = {
	--Main
	Name = 'terror'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	DrinkSound = 2752128299; --The ID of the sound that plays when the player drinks the liquid (default is 2752128299)
	DispenseSound = 'Horror3'; --The name of the sound that plays when the liquid is dispensed (default is Dispense1)
	...
	Lethal = 2; --The amount of time it takes before the player dies after drinking the liquid (setting this to nil will disable the effect)
