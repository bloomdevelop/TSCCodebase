local drink = {
	...
	RefuseMessage = 'On the side of the empty cup, there are complex blueprints. They contain a untranslatable language and indecipherable diagrams.'; --Text shown on the screen when the player attempts to drink the liquid (setting this will stop the player from drinking the liquid)
