local drink = {
	--Main
	Name = 'tomato juice'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "Meh, it's ok. Never was a big fan of tomato juice though."; --Text shown on the screen after drinking the liquid
