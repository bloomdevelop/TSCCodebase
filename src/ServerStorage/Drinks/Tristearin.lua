local drink = {
	--Main
	Name = 'stearin'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'HOT, HOT, HOT!'; --Text shown on the screen after drinking the liquid
