local drink = {
	--Main
	Name = 'violet tea'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = "It's too hot!"; --Text shown on the screen after drinking the liquid
