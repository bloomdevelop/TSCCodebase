local drink = {
	--Main
	Name = 'hot liquid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The liquid stings your mouth, it is very hot.'; --Text shown on the screen after drinking the liquid
