local drink = {
	--Main
	Name = 'wax'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'The taste makes you feel ill.'; --Text shown on the screen after drinking the liquid
