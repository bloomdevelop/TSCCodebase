local drink = {
	--Main
	Name = 'windshield washer fluid'; --The name of the liquid (setting this to "Empty Cup" will make the cup already empty)
	...
	Message = 'You feel a burning pain in your abdomen.'; --Text shown on the screen after drinking the liquid
	...
	--Appearance
	Color = BrickColor.new('Medium bluish violet');
