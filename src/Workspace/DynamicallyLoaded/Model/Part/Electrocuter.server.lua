...
local Taze = Effects.TazeIcify
local Damager = Effects.stundamager
...
Part.Touched:Connect(function(Hit)
	...
	if Humanoid ~= nil then
		...
		local DamagerClone = Damager:Clone()
		DamagerClone.Parent = Hit.Parent
		DamagerClone.Disabled = false
