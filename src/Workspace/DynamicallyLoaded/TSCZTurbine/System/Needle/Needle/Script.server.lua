...
while true do
	TS:Create(Needle,TweenInfo.new(0.2,Enum.EasingStyle.Bounce),{CFrame = Left.CFrame}):Play()
	wait(0.2)
	...
	wait(0.2)
	TS:Create(Needle,TweenInfo.new(0.6,Enum.EasingStyle.Bounce),{CFrame = FarLeft.CFrame}):Play()
	wait(0.2)
