...
local Button = script.Parent.Parent.TramCallModelTwo.ButtonSystem.Button
local ClickedPos = script.Parent.Parent.TramCallModelTwo.ButtonSystem.ClickedPos
local Neutral = script.Parent.Parent.TramCallModelTwo.ButtonSystem.Neutral
